...
#ifndef NEW_BULK_SEND_HELPER_H
#define NEW_BULK_SEND_HELPER_H
 ...
 * on a set of nodes.
 */
class NewBulkSendHelper
{
  public:
    /**
     * Create an NewBulkSendHelper to make it easier to work with BulkSendApplications
     *
     ...
     *        to.
     */
    NewBulkSendHelper(std::string protocol, Address address);
