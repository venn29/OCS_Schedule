...
class PointToPointNetDevice : public NetDevice
{
  ...
  protected:
    ...
    TxMachineState GetMachineState(){ return this->m_txMachineState;}
    void SetMachineState(TxMachineState t){ this->m_txMachineState = t;}

    void SetCurrentPacket(Ptr<Packet> p){this->m_currentPkt = p;}
    Ptr<Packet> GetCurrentPacket(){ return this->m_currentPkt;}
    DataRate GetDataRate() {return this->m_bps;}
    Time GetInterframeGap() {return this->m_tInterframeGap;}
