...
#ifndef NEW_BULK_SEND_APPLICATION_H
#define NEW_BULK_SEND_APPLICATION_H
 ...
 */
class NewBulkSendApplication : public Application
{
  public:
    /**
    ...
    NewBulkSendApplication();

    ~NewBulkSendApplication() override;
...
#endif /* NEW_BULK_SEND_APPLICATION_H */