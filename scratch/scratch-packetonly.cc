...
int main(int argc,char* argv[])
{
    ...
    Config::SetDefault("ns3::TcpSocket::DelAckTimeout", TimeValue(MicroSeconds(20)));
    ...
    Cluster2ClusterAppHelper(Hosts0,Hosts2,TorIface0,10,40001,1024*1024);
